...
const Login = () => {
    ...
    // },[])
    return (
        <div className='flex items-center w-screen mt-10 md:mt-0 md:h-screen justify-center'>
            <form onSubmit={signupHandler} className='md:shadow-lg flex flex-col gap-5 p-8'>
                <div className='my-4'>
                  <img src='hnblogo.png' className='mx-auto h-20 w-20 mb-2'></img>
                    <p className='text-sm text-center font-semibold'>Login to see what's happening in our college.</p>
                </div>
                <div>
